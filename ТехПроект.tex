...
Основные функциональные возможности платформы включают в себя:
\begin{enumerate}
	\item Создание и редактирование персонального резюме с указанием опыта работы, образования, навыков и контактной информации.
	\item Поиск вакансий по различным критериям.
	\item Подача откликов на интересующие вакансии.
	\item Отслеживание статуса поданных заявок.
	\item Размещение и управление вакансиями с детальным описанием требований и условий работы.
	\item Просмотр резюме соискателей и поиск подходящих кандидатов.
	\item Обработка входящих откликов на вакансии.
\end{enumerate}
...
\subsubsection{Фреймворк Symfony}        
...
\subsubsection{Язык  программирования JavaScript и фреймворк Vue.js}
...
\begin{enumerate}
	...
	Оптимизирована для быстрой обработки запросов, особенно в веб-приложениях с большим числом транзакций.
	
	\item Масштабируемость. 
	
	Поддерживает горизонтальное и вертикальное масштабирование через репликацию и кластеризацию.
	
	\item Интеграция. 
	
	Совместима с веб-фреймворками (Django, Laravel), NoSQL (MySQL Document Store) и платёжными 
	системами.
	
	\item Надёжность. 
	
	Транзакции (InnoDB) и репликация обеспечивают целостность данных.
...
\begin{figure}[ht]
\center{\includegraphics[width=1\linewidth]{dc2}}
...
\begin{landscape}
\begin{figure}[H]
	\center{\includegraphics[width=1\linewidth]{dcc21}}
...
\begin{enumerate}
	\item Клиент (Vue.js/JavaScript) - фронтенд-слой, включающий Vue-компоненты для отображения интерфейса, Vue Router для маршрутизации и Vuex Store для управления состоянием приложения.
	\item Веб-сервер (NGINX) - промежуточный слой, обслуживающий статические файлы и проксирующий API-запросы к backend-серверу.
	\item Сервер (Symfony/PHP) - бэкенд-слой с API-контроллерами, формами и валидацией, бизнес-сервисами и Doctrine ORM для работы с базой данных.
	\item База данных (MySQL) - слой хранения данных.
\end{enumerate}
Взаимодействие между компонентами осуществляется через HTTP/HTTPS протокол между клиентом и веб-сервером, FastCGI/PHP-FPM между веб-сервером и Symfony, и SQL/PDO соединения между приложением и базой данных MySQL.

\subsection{Структура базы данных}

Схема структуры базы данных системы, отражающая таблицы, их атрибуты, ключи и связи между ними отражена на рисунке \ref{db:image}.

\begin{landscape}
\begin{figure}[H]
	\center{\includegraphics[width=1\linewidth]{db1}}
...
\begin{xltabular}{\textwidth}{|l|l|p{1.7cm}|X|}
	\caption{Структура таблицы resume \label{ssevsws:table}}\\ \hline
...
\begin{xltabular}{\textwidth}{|l|l|p{1.7cm}|X|}
	\caption{Структура таблицы vacancy \label{vacancy:table}}\\ \hline
	\centrow Тип ключа & \centrow Имя столбца & \centrow Тип
	данных & \centrow Обязательность \\ \hline
	\thead{1} & \thead{2} & \centrow 3 & \centrow 4 \\ \hline
	\endfirsthead
...
\begin{xltabular}{\textwidth}{|l|l|p{1.7cm}|X|}
	\caption{Структура таблицы user \label{user:table}}\\ \hline
	\centrow Тип ключа & \centrow Имя столбца & \centrow Тип
	данных & \centrow Обязательность \\ \hline
	\thead{1} & \thead{2} & \centrow 3 & \centrow 4 \\ \hline
	\endfirsthead
...
\begin{xltabular}{\textwidth}{|l|l|p{1.7cm}|X|}
	\caption{Структура таблицы company \label{company:table}}\\ \hline
	\centrow Тип ключа & \centrow Имя столбца & \centrow Тип
	данных & \centrow Обязательность \\ \hline
	\thead{1} & \thead{2} & \centrow 3 & \centrow 4 \\ \hline
	\endfirsthead
...
\begin{xltabular}{\textwidth}{|l|l|p{1.7cm}|X|}
	\caption{Структура таблицы country \label{country:table}}\\ \hline
	\centrow Тип ключа & \centrow Имя столбца & \centrow Тип
	данных & \centrow Обязательность \\ \hline
	\thead{1} & \thead{2} & \centrow 3 & \centrow 4 \\ \hline
	\endfirsthead
...
\begin{xltabular}{\textwidth}{|l|l|p{1.7cm}|X|}
	\caption{Структура таблицы district \label{district:table}}\\ \hline
	\centrow Тип ключа & \centrow Имя столбца & \centrow Тип
	данных & \centrow Обязательность \\ \hline
	\thead{1} & \thead{2} & \centrow 3 & \centrow 4 \\ \hline
	\endfirsthead
...
\begin{xltabular}{\textwidth}{|l|l|p{1.7cm}|X|}
	\caption{Структура таблицы city \label{city:table}}\\ \hline
	\centrow Тип ключа & \centrow Имя столбца & \centrow Тип
	данных & \centrow Обязательность \\ \hline
	\thead{1} & \thead{2} & \centrow 3 & \centrow 4 \\ \hline
	\endfirsthead
...
\begin{xltabular}{\textwidth}{|l|l|p{1.7cm}|X|}
	\caption{Структура таблицы vacancyResponse \label{vacancyResponse:table}}\\ \hline
	\centrow Тип ключа & \centrow Имя столбца & \centrow Тип
	данных & \centrow Обязательность \\ \hline
	\thead{1} & \thead{2} & \centrow 3 & \centrow 4 \\ \hline
	\endfirsthead
...
В таблице \ref{awardAndAchievments:table} представлена структура таблицы awardAndAchievments.

\begin{xltabular}{\textwidth}{|l|l|p{1.7cm}|X|}
	\caption{Структура таблицы awardsAndAchievement \label{awardAndAchievments:table}}\\ \hline
	\centrow Тип ключа & \centrow Имя столбца & \centrow Тип
	данных & \centrow Обязательность \\ \hline
	\thead{1} & \thead{2} & \centrow 3 & \centrow 4 \\ \hline
	\endfirsthead
...
В таблице \ref{education:table} представлена структура таблицы education.

\begin{xltabular}{\textwidth}{|l|l|p{1.7cm}|X|}
	\caption{Структура таблицы education \label{education:table}}\\ \hline
	\centrow Тип ключа & \centrow Имя столбца & \centrow Тип
	данных & \centrow Обязательность \\ \hline
	\thead{1} & \thead{2} & \centrow 3 & \centrow 4 \\ \hline
	\endfirsthead
...
В таблице \ref{gender:table} представлена структура таблицы gender.

\begin{xltabular}{\textwidth}{|l|l|p{1.7cm}|X|}
	\caption{Структура таблицы gender \label{gender:table}}\\ \hline
	\centrow Тип ключа & \centrow Имя столбца & \centrow Тип
	данных & \centrow Обязательность \\ \hline
	\thead{1} & \thead{2} & \centrow 3 & \centrow 4 \\ \hline
	\endfirsthead
...
В таблице \ref{vacancyResponseStatus:table} представлена структура таблицы vacancyResponseStatus.

\begin{xltabular}{\textwidth}{|l|l|p{1.7cm}|X|}
	\caption{Структура таблицы vacancyResponseStatus \label{vacancyResponseStatus:table}}\\ \hline
	\centrow Тип ключа & \centrow Имя столбца & \centrow Тип
	данных & \centrow Обязательность \\ \hline
	\thead{1} & \thead{2} & \centrow 3 & \centrow 4 \\ \hline
	\endfirsthead
...
В таблице \ref{workPlace:table} представлена структура таблицы workPlace.

\begin{xltabular}{\textwidth}{|l|l|p{1.7cm}|X|}
	\caption{Структура таблицы workPlace \label{workPlace:table}}\\ \hline
	\centrow Тип ключа & \centrow Имя столбца & \centrow Тип
	данных & \centrow Обязательность \\ \hline
	\thead{1} & \thead{2} & \centrow 3 & \centrow 4 \\ \hline
	\endfirsthead
...
В таблице \ref{resumeCitizenshipCountry:table} представлена структура таблицы resumeCitizenshipCountry.

\begin{xltabular}{\textwidth}{|l|l|p{1.7cm}|X|}
	\caption{Структура таблицы resumeCitizenshipCountry \label{resumeCitizenshipCountry:table}}\\ \hline
	\centrow Тип ключа & \centrow Имя столбца & \centrow Тип
	данных & \centrow Обязательность \\ \hline
	\thead{1} & \thead{2} & \centrow 3 & \centrow 4 \\ \hline
	\endfirsthead
...
В таблице \ref{incomePayment:table} представлена структура таблицы incomePayment.

\begin{xltabular}{\textwidth}{|l|l|p{1.7cm}|X|}
	\caption{Структура таблицы incomePayment \label{incomePayment:table}}\\ \hline
...
В таблице \ref{jobIndustry:table} представлена структура таблицы jobIndustry.

\begin{xltabular}{\textwidth}{|l|l|p{1.7cm}|X|}
	\caption{Структура таблицы jobIndustry \label{jobIndustry:table}}\\ \hline
	\centrow Тип ключа & \centrow Имя столбца & \centrow Тип данных & \centrow Обязательность \\ \hline
	\thead{1} & \thead{2} & \centrow 3 & \centrow 4 \\ \hline
	\endfirsthead
...
В таблице \ref{levelEducation:table} представлена структура таблицы levelEducation.

\begin{xltabular}{\textwidth}{|l|l|p{1.7cm}|X|}
	\caption{Структура таблицы levelEducation \label{levelEducation:table}}\\ \hline
	\centrow Тип ключа & \centrow Имя столбца & \centrow Тип данных & \centrow Обязательность \\ \hline
	\thead{1} & \thead{2} & \centrow 3 & \centrow 4 \\ \hline
	\endfirsthead
...
В таблице \ref{userRoles:table} представлена структура таблицы userRoles.

\begin{xltabular}{\textwidth}{|l|l|p{1.7cm}|X|}
	\caption{Структура таблицы userRoles \label{userRoles:table}}\\ \hline
	\centrow Тип ключа & \centrow Имя столбца & \centrow Тип данных & \centrow Обязательность \\ \hline
	\thead{1} & \thead{2} & \centrow 3 & \centrow 4 \\ \hline
	\endfirsthead
...
В таблице \ref{vacancyCompanyIndustry:table} представлена структура таблицы vacancyCompanyIndustry.

\begin{xltabular}{\textwidth}{|l|l|p{1.7cm}|X|}
	\caption{Структура таблицы vacancyCompanyIndustry \label{vacancyCompanyIndustry:table}}\\ \hline
	\centrow Тип ключа & \centrow Имя столбца & \centrow Тип данных & \centrow Обязательность \\ \hline
	\thead{1} & \thead{2} & \centrow 3 & \centrow 4 \\ \hline
	\endfirsthead
...
В таблице \ref{vacancyEducation:table} представлена структура таблицы vacancyEducation.

\begin{xltabular}{\textwidth}{|l|l|p{1.7cm}|X|}
	\caption{Структура таблицы vacancyEducation \label{vacancyEducation:table}}\\ \hline
	\centrow Тип ключа & \centrow Имя столбца & \centrow Тип данных & \centrow Обязательность \\ \hline
	\thead{1} & \thead{2} & \centrow 3 & \centrow 4 \\ \hline
	\endfirsthead
...
В таблице \ref{vacancyEmploymentType:table} представлена структура таблицы vacancyEmploymentType.

\begin{xltabular}{\textwidth}{|l|l|p{1.7cm}|X|}
	\caption{Структура таблицы vacancyEmploymentType \label{vacancyEmploymentType:table}}\\ \hline
	\centrow Тип ключа & \centrow Имя столбца & \centrow Тип данных & \centrow Обязательность \\ \hline
	\thead{1} & \thead{2} & \centrow 3 & \centrow 4 \\ \hline
	\endfirsthead
...
В таблице \ref{vacancyIncomePayment:table} представлена структура таблицы vacancyIncomePayment.

\begin{xltabular}{\textwidth}{|l|l|p{1.7cm}|X|}
	\caption{Структура таблицы vacancyIncomePayment \label{vacancyIncomePayment:table}}\\ \hline
	\centrow Тип ключа & \centrow Имя столбца & \centrow Тип данных & \centrow Обязательность \\ \hline
	\thead{1} & \thead{2} & \centrow 3 & \centrow 4 \\ \hline
	\endfirsthead
...
В таблице \ref{vacancySpecializations:table} представлена структура таблицы vacancySpecializations.

\begin{xltabular}{\textwidth}{|l|l|p{1.7cm}|X|}
	\caption{Структура таблицы vacancySpecializations \label{vacancySpecializations:table}}\\ \hline
	\centrow Тип ключа & \centrow Имя столбца & \centrow Тип данных & \centrow Обязательность \\ \hline
	\thead{1} & \thead{2} & \centrow 3 & \centrow 4 \\ \hline
	\endfirsthead
...
В таблице \ref{vacancyWorkExperience:table} представлена структура таблицы vacancyWorkExperience.

\begin{xltabular}{\textwidth}{|l|l|p{1.7cm}|X|}
	\caption{Структура таблицы vacancyWorkExperience \label{vacancyWorkExperience:table}}\\ \hline
	\centrow Тип ключа & \centrow Имя столбца & \centrow Тип данных & \centrow Обязательность \\ \hline
	\thead{1} & \thead{2} & \centrow 3 & \centrow 4 \\ \hline
	\endfirsthead
...
В таблице \ref{vacancyWorkSchedule:table} представлена структура таблицы vacancyWorkSchedule.

\begin{xltabular}{\textwidth}{|l|l|p{1.7cm}|X|}
	\caption{Структура таблицы vacancyWorkSchedule \label{vacancyWorkSchedule:table}}\\ \hline
	\centrow Тип ключа & \centrow Имя столбца & \centrow Тип данных & \centrow Обязательность \\ \hline
	\thead{1} & \thead{2} & \centrow 3 & \centrow 4 \\ \hline
	\endfirsthead
