...
В таблице \ref{resumeCity:table} представлена структура таблицы resumeCity.
...
В таблице \ref{resumeVacancyEmploymentType:table} представлена структура таблицы resumeVacancyEmploymentType.
...
В таблице \ref{userResume:table} представлена структура таблицы userResume.
...
В таблице \ref{userVacancy:table} представлена структура таблицы userVacancy.
...
В таблице \ref{vacancyCity:table} представлена структура таблицы vacancyCity.
...
В таблице \ref{vacancyVacancyCompanyIndustry:table} представлена структура таблицы vacancyVacancyCompanyIndustry.
...
В таблице \ref{vacancyVacancyEmploymentType:table} представлена структура таблицы vacancyVacancyEmploymentType.
...
В таблице \ref{vacancyVacancySpecializations:table} представлена структура таблицы vacancyVacancySpecializations.
...
В таблице \ref{vacancyVacancyWorkSchedule:table} представлена структура таблицы vacancyVacancyWorkSchedule.
